...
# ✅ Multilingual Texts (English, Hindi, Kannada)
texts = {
    "en": {
    ...
    "hi": {
        ...
        "delivery": "15–20 मिनट में डिलीवरी",
        "post_product": "उत्पाद जोड़ें",
        "your_name": "आपका नाम",
        "product_name": "उत्पाद",
        "price": "कीमत",
        "use_case": "उपयोग का उद्देश्य",
        "order_confirmed": "ऑर्डर की पुष्टि हो गई!",
        "thank_you": "आपकी खरीदारी के लिए धन्यवाद!",
        "payment_info": "डिलीवरी पर भुगतान करें। विक्रेता आपसे जल्द संपर्क करेगा।",
        "your_location": "आपका स्थान",
        "confirm_order": "ऑर्डर की पुष्टि करें",
        "marketplace": "बाज़ार",
        "vendor_only_warning": "यह वस्तु केवल सत्यापित विक्रेताओं के लिए उपलब्ध है।",
        "vendor_checkbox": "मैं एक पंजीकृत विक्रेता हूं",
        "choose_role": "क्या आप खरीदने या बेचने के लिए हैं?",
        "buy": "खरीदें",
        "sell": "बेचें",
        "cart": "कार्ट",
    ...
    "kn": {
        "title": "ಸೇಫ್ಬೈಟ್ ಸರಬರಾಜು",
        "welcome": "ಸೇಫ್ಬೈಟ್ ಸರಬರಾಜಿಗೆ ಸ್ವಾಗತ!",
        "description": "ಶುದ್ಧತೆಯುಳ್ಳ ವಿತರಕರನ್ನು ಬೀದಿ ಆಹಾರದ ವ್ಯಾಪಾರಿಗಳಿಗೆ ಸಂಪರ್ಕಿಸುತ್ತಿದೆ.",
        "quality_note": "ಎಲ್ಲಾ ಉತ್ಪನ್ನಗಳನ್ನು ಗುಣಮಟ್ಟ ಮತ್ತು ಸ್ವಚ್ಛತೆಗೆ ಪರಿಶೀಲಿಸಲಾಗಿದೆ.",
        "product_list": "ಉತ್ಪನ್ನಗಳನ್ನು ವೀಕ್ಷಿಸಿ",
        "sell_heading": "ಉತ್ಪನ್ನವನ್ನು ಮಾರಾಟ ಮಾಡಿ",
        "cod": "ನಗದು ಮೂಲಕ ಪಾವತಿ",
        "sold_by": "ಮೂಲಕ ಮಾರಾಟವಾಗಿದೆ",
        "delivery": "15–20 ನಿಮಿಷಗಳಲ್ಲಿ ವಿತರಣೆ",
        "post_product": "ಉತ್ಪನ್ನವನ್ನು ಪೋಸ್ಟ್ ಮಾಡಿ",
        "your_name": "ನಿಮ್ಮ ಹೆಸರು",
        "product_name": "ಉತ್ಪನ್ನ",
        "price": "ಬೆಲೆ",
        "use_case": "ಉದ್ದೇಶಿತ ಬಳಕೆ",
        "order_confirmed": "ಆರ್ಡರ್ ದೃಢಪಡಿಸಲಾಗಿದೆ!",
        "thank_you": "ನಿಮ್ಮ ಖರೀದಿಗೆ ಧನ್ಯವಾದಗಳು!",
        "payment_info": "ವಿತರಣೆಯ ಸಮಯದಲ್ಲಿ ಪಾವತಿ ಮಾಡಿ. ವಿತರಕರು ಶೀಘ್ರದಲ್ಲೇ ಸಂಪರ್ಕಿಸುತ್ತಾರೆ.",
        "your_location": "ನಿಮ್ಮ ಸ್ಥಳ",
        "confirm_order": "ಆರ್ಡರ್ ದೃಢೀಕರಿಸಿ",
        "marketplace": "ಮಾರ್ಕೆಟ್‌ಪ್ಲೇಸ್",
        "vendor_only_warning": "ಈ ಐಟಮ್ ಮಾನ್ಯತೆಯುತ ವಿತರಕರಿಗೆ ಮಾತ್ರ ಲಭ್ಯವಿದೆ.",
        "vendor_checkbox": "ನಾನು ನೋಂದಾಯಿತ ವಿತರಕರಾಗಿದ್ದೇನೆ",
        "choose_role": "ನೀವು ಖರೀದಿಸಲು ಅಥವಾ ಮಾರಾಟ ಮಾಡಲು ಬಂದಿದ್ದೀರಾ?",
        "buy": "ಖರೀದಿ",
        "sell": "ಮಾರಾಟ",
        "cart": "ಕಾರ್ಟ್",
        "empty_cart": "ನಿಮ್ಮ ಕಾರ್ಟ್ ಖಾಲಿಯಾಗಿದೆ.",
        "view_cart": "ಕಾರ್ಟ್ ವೀಕ್ಷಿಸಿ",
        "added": "ಕಾರ್ಟ್‌ಗೆ ಸೇರಿಸಲಾಗಿದೆ",
        "removed": "ಕಾರ್ಟ್‌ನಿಂದ ತೆಗೆದುಹಾಕಲಾಗಿದೆ"
    }
}
...
products = [
    ...
    {"name": "Onions (1kg)", "price": 30, "image": "onions.jpg"},
    {"name": "Potatoes (1kg)", "price": 25, "image": "potatoes.jpg"},
    {"name": "Cooking Oil (1L)", "price": 110, "image": "oil.jpg"},
    {"name": "Green Chillies (100g)", "price": 10, "image": "chillies.jpg"},
    {"name": "Tomatoes (1kg)", "price": 35, "image": "tomatoes.jpg"},
    {"name": "Coriander Leaves (1 bunch)", "price": 8, "image": "coriander.jpg"},
    {"name": "Cabbage (1 piece)", "price": 20, "image": "cabbage.jpg"},
]
...
# ✅ Set Language (used by a dropdown or form)
